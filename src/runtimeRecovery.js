...
const moduleLoadFailure = /importing a module script failed|failed to fetch dynamically imported module|error loading dynamically imported module|loading (?:css )?chunk [^ ]+ failed|chunkloaderror|not a valid javascript mime type|javascript module script.*mime type/i;
